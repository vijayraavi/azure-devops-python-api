...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <azure.devops.v4_1.microsoft._visual_studio._services._web_api.models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <azure.devops.v4_1.microsoft._visual_studio._services._web_api.models.EventScope>`
    """

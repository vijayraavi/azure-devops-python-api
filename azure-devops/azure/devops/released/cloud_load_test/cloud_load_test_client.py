...
from ...v4_1.cloud_load_test import models
...
class CloudLoadTestClient(Client):
    ...
    def create_agent_group(self, group):
        ...
        :rtype: :class:`<AgentGroup> <azure.devops.v4_1.cloud_load_test.models.AgentGroup>`
        """
    ...
    def get_application(self, application_id):
        ...
        :rtype: :class:`<Application> <azure.devops.v4_1.cloud_load_test.models.Application>`
        """
        route_values = {}
    ...
    def get_counter_samples(self, counter_sample_query_details, test_run_id):
        ...
        :param str test_run_id: The test run identifier
        :rtype: :class:`<CounterSamplesResult> <azure.devops.v4_1.cloud_load_test.models.CounterSamplesResult>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def get_load_test_run_errors(self, test_run_id, type=None, sub_type=None, detailed=None):
        ...
        :rtype: :class:`<LoadTestErrors> <azure.devops.v4_1.cloud_load_test.models.LoadTestErrors>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def get_plugin(self, type):
        ...
        :rtype: :class:`<ApplicationType> <azure.devops.v4_1.cloud_load_test.models.ApplicationType>`
        """
        route_values = {}
        if type is not None:
    ...
    def get_load_test_result(self, test_run_id):
        """GetLoadTestResult.
        :param str test_run_id: The test run identifier
        :rtype: :class:`<TestResults> <azure.devops.v4_1.cloud_load_test.models.TestResults>`
        """
        route_values = {}
        if test_run_id is not None:
            route_values['testRunId'] = self._serialize.url('test_run_id', test_run_id, 'str')
    ...
    def create_test_definition(self, test_definition):
        ...
        :rtype: :class:`<TestDefinition> <azure.devops.v4_1.cloud_load_test.models.TestDefinition>`
        """
    ...
    def create_test_drop(self, web_test_drop):
        ...
        :rtype: :class:`<Microsoft.VisualStudio.TestService.WebApiModel.TestDrop> <azure.devops.v4_1.cloud_load_test.models.Microsoft.VisualStudio.TestService.WebApiModel.TestDrop>`
        """
    ...
    def create_test_run(self, web_test_run):
        ...
        :rtype: :class:`<TestRun> <azure.devops.v4_1.cloud_load_test.models.TestRun>`
        """

...
class FieldModel(Model):
    ...
    :type name: str
    :param pick_list:
    :type pick_list: :class:`PickListMetadataModel <azure.devops.v4_0.work_item_tracking.models.PickListMetadataModel>`
    :param type:
    :type type: object
    :param url:
    :type url: str
...
class PickListModel(PickListMetadataModel):
    ...
    :type url: str
    :param items:
    :type items: list of :class:`PickListItemModel <azure.devops.v4_0.work_item_tracking.models.PickListItemModel>`
    """

...
class WorkItemTrackingClient(Client):
    ...
    def add_control_to_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <azure.devops.v4_0.work_item_tracking.models.Control>` control:
        :param str process_id:
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        """AddGroup.
        [Preview API]
        :param :class:`<Group> <azure.devops.v4_0.work_item_tracking.models.Group>` group:
        :param str process_id:
        :param str wit_ref_name:
        :param str page_id:
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        """HideStateDefinition.
        [Preview API]
        :param :class:`<HideStateModel> <azure.devops.v4_0.work_item_tracking.models.HideStateModel>` hide_state_model:
        :param str process_id:
        :param str wit_ref_name:
        :param str state_id:
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v4_0.work_item_tracking.models.WorkItemStateResultModel>`

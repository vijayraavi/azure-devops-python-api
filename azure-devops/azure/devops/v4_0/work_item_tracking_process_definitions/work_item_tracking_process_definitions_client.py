...
class WorkItemTrackingProcessDefinitionsClient(Client):
    ...
    def create_behavior(self, behavior, process_id):
        """CreateBehavior.
        [Preview API]
        :param :class:`<BehaviorCreateModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.BehaviorCreateModel>` behavior:
        :param str process_id:
        :rtype: :class:`<BehaviorModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.BehaviorModel>`
        """
        route_values = {}
    ...
    def replace_behavior(self, behavior_data, process_id, behavior_id):
        """ReplaceBehavior.
        [Preview API]
        :param :class:`<BehaviorReplaceModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.BehaviorReplaceModel>` behavior_data:
        :param str process_id:
        :param str behavior_id:
        :rtype: :class:`<BehaviorModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.BehaviorModel>`
        """
    ...
    def add_control_to_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Control>` control:
        :param str process_id:
        :param str wit_ref_name:
        :param str group_id:
        :rtype: :class:`<Control> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Control>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_field(self, field, process_id):
        """CreateField.
        [Preview API]
        :param :class:`<FieldModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.FieldModel>` field:
        :param str process_id:
        :rtype: :class:`<FieldModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.FieldModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_field(self, field, process_id):
        """UpdateField.
        [Preview API]
        :param :class:`<FieldUpdate> <azure.devops.v4_0.work_item_tracking_process_definitions.models.FieldUpdate>` field:
        :param str process_id:
        :rtype: :class:`<FieldModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.FieldModel>`
        """
        route_values = {}
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        """AddGroup.
        [Preview API]
        :param :class:`<Group> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Group>` group:
        :param str process_id:
        :param str wit_ref_name:
        :param str page_id:
        :param str section_id:
        :rtype: :class:`<Group> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Group>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def get_form_layout(self, process_id, wit_ref_name):
        ...
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<FormLayout> <azure.devops.v4_0.work_item_tracking_process_definitions.models.FormLayout>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_list(self, picklist):
        """CreateList.
        [Preview API]
        :param :class:`<PickListModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.PickListModel>` picklist:
        :rtype: :class:`<PickListModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.PickListModel>`
        """
    ...
    def add_page(self, page, process_id, wit_ref_name):
        """AddPage.
        [Preview API]
        :param :class:`<Page> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Page>` page:
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<Page> <azure.devops.v4_0.work_item_tracking_process_definitions.models.Page>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_state_definition(self, state_model, process_id, wit_ref_name):
        ...
        [Preview API]
        :param :class:`<WorkItemStateInputModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemStateInputModel>` state_model:
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        """HideStateDefinition.
        [Preview API]
        :param :class:`<HideStateModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.HideStateModel>` hide_state_model:
        :param str process_id:
        :param str wit_ref_name:
        :param str state_id:
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemStateResultModel>`
    ...
    def add_behavior_to_work_item_type(self, behavior, process_id, wit_ref_name_for_behaviors):
        ...
        [Preview API]
        :param :class:`<WorkItemTypeBehavior> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeBehavior>` behavior:
        :param str process_id:
        :param str wit_ref_name_for_behaviors:
        :rtype: :class:`<WorkItemTypeBehavior> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeBehavior>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_work_item_type(self, work_item_type, process_id):
        """CreateWorkItemType.
        [Preview API]
        :param :class:`<WorkItemTypeModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>` work_item_type:
        :param str process_id:
        :rtype: :class:`<WorkItemTypeModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_work_item_type(self, work_item_type_update, process_id, wit_ref_name):
        """UpdateWorkItemType.
        [Preview API]
        :param :class:`<WorkItemTypeUpdateModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeUpdateModel>` work_item_type_update:
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<WorkItemTypeModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>`
        """
    ...
    def add_field_to_work_item_type(self, field, process_id, wit_ref_name_for_fields):
        ...
        [Preview API]
        :param :class:`<WorkItemTypeFieldModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeFieldModel>` field:
        :param str process_id:
        :param str wit_ref_name_for_fields:
        :rtype: :class:`<WorkItemTypeFieldModel> <azure.devops.v4_0.work_item_tracking_process_definitions.models.WorkItemTypeFieldModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')

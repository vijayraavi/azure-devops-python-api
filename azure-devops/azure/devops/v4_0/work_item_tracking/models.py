...
class AccountMyWorkResult(Model):
    ...
    :type work_item_details: list of :class:`AccountWorkWorkItemModel <azure.devops.v4_0.work_item_tracking.models.AccountWorkWorkItemModel>`
    """
...
class ProjectWorkItemStateColors(Model):
    ...
    :type work_item_type_state_colors: list of :class:`WorkItemTypeStateColors <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeStateColors>`
    """
...
class QueryHierarchyItemsResult(Model):
    ...
    :type has_more: bool
    :param value:
    :type value: list of :class:`QueryHierarchyItem <azure.devops.v4_0.work_item_tracking.models.QueryHierarchyItem>`
    """
...
class ReportingWorkItemLink(Model):
    ...
    :param changed_by:
    :type changed_by: :class:`IdentityRef <azure.devops.v4_0.work_item_tracking.models.IdentityRef>`
    :param changed_date:
    :type changed_date: datetime
...
class WorkItemComments(Model):
    ...
    :param comments:
    :type comments: list of :class:`WorkItemComment <azure.devops.v4_0.work_item_tracking.models.WorkItemComment>`
    :param count:
    :type count: int
...
class WorkItemLink(Model):
    ...
    :type rel: str
    :param source:
    :type source: :class:`WorkItemReference <azure.devops.v4_0.work_item_tracking.models.WorkItemReference>`
    :param target:
    :type target: :class:`WorkItemReference <azure.devops.v4_0.work_item_tracking.models.WorkItemReference>`
    """
...
class WorkItemQueryClause(Model):
    ...
    :param clauses:
    :type clauses: list of :class:`WorkItemQueryClause <azure.devops.v4_0.work_item_tracking.models.WorkItemQueryClause>`
    :param field:
    :type field: :class:`WorkItemFieldReference <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldReference>`
    :param field_value:
    :type field_value: :class:`WorkItemFieldReference <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldReference>`
    :param is_field_value:
    :type is_field_value: bool
    :param logical_operator:
    :type logical_operator: object
    :param operator:
    :type operator: :class:`WorkItemFieldOperation <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldOperation>`
    :param value:
    :type value: str
    """
...
class WorkItemQueryResult(Model):
    ...
    :type as_of: datetime
    :param columns:
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldReference>`
    :param query_result_type:
    :type query_result_type: object
    :param query_type:
    :type query_type: object
    :param sort_columns:
    :type sort_columns: list of :class:`WorkItemQuerySortColumn <azure.devops.v4_0.work_item_tracking.models.WorkItemQuerySortColumn>`
    :param work_item_relations:
    :type work_item_relations: list of :class:`WorkItemLink <azure.devops.v4_0.work_item_tracking.models.WorkItemLink>`
    :param work_items:
    :type work_items: list of :class:`WorkItemReference <azure.devops.v4_0.work_item_tracking.models.WorkItemReference>`
    """
...
class WorkItemRelationUpdates(Model):
    ...
    :param added:
    :type added: list of :class:`WorkItemRelation <azure.devops.v4_0.work_item_tracking.models.WorkItemRelation>`
    :param removed:
    :type removed: list of :class:`WorkItemRelation <azure.devops.v4_0.work_item_tracking.models.WorkItemRelation>`
    :param updated:
    :type updated: list of :class:`WorkItemRelation <azure.devops.v4_0.work_item_tracking.models.WorkItemRelation>`
    """
...
class WorkItemTypeStateColors(Model):
    ...
    :type state_colors: list of :class:`WorkItemStateColor <azure.devops.v4_0.work_item_tracking.models.WorkItemStateColor>`
...
class WorkItemUpdate(WorkItemTrackingResourceReference):
    ...
    :type id: int
    :param relations:
    :type relations: :class:`WorkItemRelationUpdates <azure.devops.v4_0.work_item_tracking.models.WorkItemRelationUpdates>`
    :param rev:
    :type rev: int
    :param revised_by:
    :type revised_by: :class:`IdentityReference <azure.devops.v4_0.work_item_tracking.models.IdentityReference>`
    :param revised_date:
...
class WorkItemDelete(WorkItemDeleteReference):
    ...
    :type url: str
    :param resource:
    :type resource: :class:`WorkItem <azure.devops.v4_0.work_item_tracking.models.WorkItem>`
    """
...
class WorkItemTrackingResource(WorkItemTrackingResourceReference):
    ...
    :type url: str
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.work_item_tracking.models.ReferenceLinks>`
    """
...
class WorkItemType(WorkItemTrackingResource):
    ...
    :type field_instances: list of :class:`WorkItemTypeFieldInstance <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param fields:
    :type fields: list of :class:`WorkItemTypeFieldInstance <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param icon:
    :type icon: :class:`WorkItemIcon <azure.devops.v4_0.work_item_tracking.models.WorkItemIcon>`
    :param name:
    :type name: str
    :param transitions:
...
class WorkItemTypeCategory(WorkItemTrackingResource):
    ...
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeReference>`
    :param name:
    :type name: str
    :param reference_name:
    :type reference_name: str
    :param work_item_types:
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeReference>`
    """
...
class FieldDependentRule(WorkItemTrackingResource):
    ...
    :type dependent_fields: list of :class:`WorkItemFieldReference <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldReference>`
    """
...
class QueryHierarchyItem(WorkItemTrackingResource):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.work_item_tracking.models.ReferenceLinks>`
    :param children:
    :type children: list of :class:`QueryHierarchyItem <azure.devops.v4_0.work_item_tracking.models.QueryHierarchyItem>`
    :param clauses:
    :type clauses: :class:`WorkItemQueryClause <azure.devops.v4_0.work_item_tracking.models.WorkItemQueryClause>`
    :param columns:
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldReference>`
    :param created_by:
    :type created_by: :class:`IdentityReference <azure.devops.v4_0.work_item_tracking.models.IdentityReference>`
    :param created_date:
    ...
    :type last_modified_by: :class:`IdentityReference <azure.devops.v4_0.work_item_tracking.models.IdentityReference>`
    :param last_modified_date:
    :type last_modified_date: datetime
    :param link_clauses:
    :type link_clauses: :class:`WorkItemQueryClause <azure.devops.v4_0.work_item_tracking.models.WorkItemQueryClause>`
    :param name:
    :type name: str
    :param path:
    :type path: str
    ...
    :type source_clauses: :class:`WorkItemQueryClause <azure.devops.v4_0.work_item_tracking.models.WorkItemQueryClause>`
    :param target_clauses:
    :type target_clauses: :class:`WorkItemQueryClause <azure.devops.v4_0.work_item_tracking.models.WorkItemQueryClause>`
    :param wiql:
    :type wiql: str
    """
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type id: int
    :param relations:
    :type relations: list of :class:`WorkItemRelation <azure.devops.v4_0.work_item_tracking.models.WorkItemRelation>`
    :param rev:
    :type rev: int
    """
...
class WorkItemClassificationNode(WorkItemTrackingResource):
    ...
    :type attributes: dict
    :param children:
    :type children: list of :class:`WorkItemClassificationNode <azure.devops.v4_0.work_item_tracking.models.WorkItemClassificationNode>`
    :param id:
    :type id: int
    :param identifier:
    :type identifier: str
...
class WorkItemField(WorkItemTrackingResource):
    ...
    :type supported_operations: list of :class:`WorkItemFieldOperation <azure.devops.v4_0.work_item_tracking.models.WorkItemFieldOperation>`
    :param type:
    :type type: object
    """

...
class WorkItemTrackingProcessClient(Client):
    ...
    def get_behavior(self, process_id, behavior_ref_name, expand=None):
        ...
        :param str expand:
        :rtype: :class:`<WorkItemBehavior> <azure.devops.v4_0.work_item_tracking_process.models.WorkItemBehavior>`
        """
        route_values = {}
    ...
    def create_process(self, create_request):
        """CreateProcess.
        [Preview API]
        :param :class:`<CreateProcessModel> <azure.devops.v4_0.work_item_tracking_process.models.CreateProcessModel>` create_request:
        :rtype: :class:`<ProcessModel> <azure.devops.v4_0.work_item_tracking_process.models.ProcessModel>`
        """
    ...
    def update_process(self, update_request, process_type_id):
        """UpdateProcess.
        [Preview API]
        :param :class:`<UpdateProcessModel> <azure.devops.v4_0.work_item_tracking_process.models.UpdateProcessModel>` update_request:
        :param str process_type_id:
        :rtype: :class:`<ProcessModel> <azure.devops.v4_0.work_item_tracking_process.models.ProcessModel>`
        """
        route_values = {}
    ...
    def add_work_item_type_rule(self, field_rule, process_id, wit_ref_name):
        """AddWorkItemTypeRule.
        [Preview API]
        :param :class:`<FieldRuleModel> <azure.devops.v4_0.work_item_tracking_process.models.FieldRuleModel>` field_rule:
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<FieldRuleModel> <azure.devops.v4_0.work_item_tracking_process.models.FieldRuleModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def get_state_definition(self, process_id, wit_ref_name, state_id):
        ...
        :param str wit_ref_name:
        :param str state_id:
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v4_0.work_item_tracking_process.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def get_work_item_type(self, process_id, wit_ref_name, expand=None):
        ...
        :param str wit_ref_name:
        :param str expand:
        :rtype: :class:`<WorkItemTypeModel> <azure.devops.v4_0.work_item_tracking_process.models.WorkItemTypeModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')

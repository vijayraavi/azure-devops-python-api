...
class WorkItemTrackingClient(Client):
    ...
    def get_behavior(self, process_id, behavior_ref_name, expand=None):
        ...
        :param str expand:
        :rtype: :class:`<WorkItemBehavior> <azure.devops.v4_0.work_item_tracking.models.WorkItemBehavior>`
        """
        route_values = {}
    ...
    def create_process(self, create_request):
        ...
        :rtype: :class:`<ProcessModel> <azure.devops.v4_0.work_item_tracking.models.ProcessModel>`
        """
    ...
    def add_work_item_type_rule(self, field_rule, process_id, wit_ref_name):
        ...
        :param str process_id:
        :param str wit_ref_name:
        :rtype: :class:`<FieldRuleModel> <azure.devops.v4_0.work_item_tracking.models.FieldRuleModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')

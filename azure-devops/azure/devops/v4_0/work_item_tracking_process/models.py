...
class Control(Model):
    ...
    :type contribution: :class:`WitContribution <azure.devops.v4_0.work_item_tracking.models.WitContribution>`
...
class FieldRuleModel(Model):
    ...
    :param actions:
    :type actions: list of :class:`RuleActionModel <azure.devops.v4_0.work_item_tracking.models.RuleActionModel>`
    :param conditions:
    :type conditions: list of :class:`RuleConditionModel <azure.devops.v4_0.work_item_tracking.models.RuleConditionModel>`
    :param friendly_name:
...
class FormLayout(Model):
    ...
    :type extensions: list of :class:`Extension <azure.devops.v4_0.work_item_tracking.models.Extension>`
    :param pages: Top level tabs of the layout.
    :type pages: list of :class:`Page <azure.devops.v4_0.work_item_tracking.models.Page>`
    :param system_controls: Headers controls of the layout.
    :type system_controls: list of :class:`Control <azure.devops.v4_0.work_item_tracking.models.Control>`
    """
...
class Group(Model):
    ...
    :type controls: list of :class:`Control <azure.devops.v4_0.work_item_tracking.models.Control>`
...
class Page(Model):
    ...
    :type sections: list of :class:`Section <azure.devops.v4_0.work_item_tracking.models.Section>`
...
class ProcessModel(Model):
    ...
    :type name: str
    :param projects:
    :type projects: list of :class:`ProjectReference <azure.devops.v4_0.work_item_tracking.models.ProjectReference>`
    :param properties:
    :type properties: :class:`ProcessProperties <azure.devops.v4_0.work_item_tracking.models.ProcessProperties>`
    :param reference_name:
    :type reference_name: str
    :param type_id:
    :type type_id: str
...
class Section(Model):
    ...
    :param groups:
    :type groups: list of :class:`Group <azure.devops.v4_0.work_item_tracking.models.Group>`
    :param id: The id for the layout node.
    :type id: str
    :param overridden: A value indicating whether this layout node has been overridden by a child layout.
    :type overridden: bool
...
class WorkItemBehavior(Model):
    ...
    :type description: str
    :param fields:
    :type fields: list of :class:`WorkItemBehaviorField <azure.devops.v4_0.work_item_tracking.models.WorkItemBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: :class:`WorkItemBehaviorReference <azure.devops.v4_0.work_item_tracking.models.WorkItemBehaviorReference>`
    :param name:
    :type name: str
    :param overriden:
    :type overriden: bool
...
class WorkItemTypeBehavior(Model):
    ...
    :param behavior:
    :type behavior: :class:`WorkItemBehaviorReference <azure.devops.v4_0.work_item_tracking.models.WorkItemBehaviorReference>`
    :param is_default:
    :type is_default: bool
    :param url:
    :type url: str
...
class WorkItemTypeModel(Model):
    ...
    :param behaviors:
    :type behaviors: list of :class:`WorkItemTypeBehavior <azure.devops.v4_0.work_item_tracking.models.WorkItemTypeBehavior>`
    :param class_:
    :type class_: object
    :param color:
    :type color: str
    ...
    :type is_disabled: bool
    :param layout:
    :type layout: :class:`FormLayout <azure.devops.v4_0.work_item_tracking.models.FormLayout>`
    :param name:
    :type name: str
    :param states:
    :type states: list of :class:`WorkItemStateResultModel <azure.devops.v4_0.work_item_tracking.models.WorkItemStateResultModel>`
    :param url:
    :type url: str
    """

...
class AdminBehavior(Model):
    ...
    :param fields:
    :type fields: list of :class:`AdminBehaviorField <azure.devops.v4_0.work_item_tracking_process_template.models.AdminBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: str
...
class ProcessImportResult(Model):
    ...
    :type validation_results: list of :class:`ValidationIssue <azure.devops.v4_0.work_item_tracking_process_template.models.ValidationIssue>`
    """
